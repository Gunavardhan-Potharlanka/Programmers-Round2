...
tit.textContent = 'TIC TAC TOE';
tit.style.marginTop = '10px';
tit.style.marginBottom = '30px';
tit.style.fontSize = '2.5rem';
let turn = document.createElement('p');
turn.id='turn';
turn.style.fontSize = '1.5rem';
turn.style.marginBottom = '25px';
...
for(let i=0;i<9;i++){
    ...
    b.style.border = '.5px solid rgb(132, 30, 233)';
...
Congrats.style.backgroundColor = 'black';
